<template>
  <div>
    <div class="section section-margin">
      <div class="container">
        <div class="not-active" v-if="dataUserLogin.isActive == false || dataUserLogin.isActive == 'false'">
          <h3 class="cart__title">Tài khoản của bạn đã bị vô hiệu hóa! Vui lòng liên hệ admin để mở khóa. Xin cảm ơn!!!</h3>
        </div>
        <div v-else>
          <div class="row">
            ...
            <div class="note my-5 text-start">
              ...
              <div class="note-content">
                <p>
                  ...
                  >Hiện tại, do tình hình dịch bệnh diễn biến phức tạp và giá
                  xăng dầu đang tăng cao. Phí ship của tất cả đơn hàng là
                  35.000đ và giao hàng khắp 64 tỉnh thành!
                </p>
              </div>
            </div>
