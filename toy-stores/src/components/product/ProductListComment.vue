<template>
  <div class="comment-area-wrapper mt-5">
    ...
    <h3 class="title mb-6">{{ productDetail.comment.length }} Bình luận</h3>
    <div
      class="single-comment-wrap mb-6 bg-milky"
      v-for="(item, index) in listComments"
      :key="index"
    >
      <div class="author-thumb">
        <img :src="item.photoURL" alt="Author" />
      </div>
...
export default {
  ...
  created() {
    this.listComments = this.productDetail.comment;
  },
};
</script>
